...
On the left side, you'll see the main modules, like Java. Click on one, and you'll find a nested folder structure for that module.
...
Where possible, pages will follow a layout in-terms of folder structure and naming conventions.
...
Each module commences with an introductory page, a high-level explanation of what it entails, the aims, and if relevant, an environment setup.
...
For instance, in the Java module, we will start with a <TextTooltip text="hello-world"/> project, and finish with some basic 2D games.
...
If you are a beginner I highly recommend starting with the [Source Control](/docs/source-control) page.
