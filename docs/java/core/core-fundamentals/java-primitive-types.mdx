...
The boolean type can have one of two values, <code>true</code> and <code>false</code>. It is used for evaluating logical conditions, and is typically used
...
<code>Typically stored using 1 bit but this is not explicitly defined in Java</code>
...
If you choose to initialize a byte variable outside of the types range, will result in a compilation error.
...
<code>Stored using 16 bits</code>
...
<code>Stored using 32 bits</code>
...
<code>Stored using 64 bits</code>
...
So storing 12557.2651111 would result in a float value of <code>12557.265f</code>.
