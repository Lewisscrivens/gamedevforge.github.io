...
The `byte` type represents an 8-bit <TextTooltip text="signed"/> integer. It can hold numerical values ranging from `-128` to `127`. These types are most commonly used when memory
...
The `short` type represents a 16-bit <TextTooltip text="signed"/> integer. It can hold numerical values ranging from `-32,768` to `32,767`. These types are commonly used when memory
...
Attempting to initialize a `short` variable outside the types range, will result in a compilation error.
...
The `int` type represents a 32-bit <TextTooltip text="signed"/> integer. It can hold numerical values ranging from `-2,147,483,648` to `2,147,483,647`.
...
Attempting to initialize an `int` variable outside the types range, will result in a compilation error.
...
It can hold numerical values ranging from `-9,223,372,036,854,775,808` to `9,223,372,036,854,775,807`.
...
Attempting to initialize a `long` variable outside the types range, will result in a compilation error.
...
long errorValue = 10000000000000000000000L;   // Value is outside of the types range, would result in a compilation error
```
...
A `float` type has limited precision and can only represent a certain number of decimal places.
