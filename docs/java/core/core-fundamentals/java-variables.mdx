...
This can be used however you see fit, I rarely use it, but it can be useful for complex types; these could change with different versions
...
it easier for team based projects it makes the code less readable. It's a hot topic especially in the game industry where C++ is one of the
most common languages with its equivalent being the `auto` keyword.
