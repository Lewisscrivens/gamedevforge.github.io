...
There is of course, much better modern solutions for game development like Unreal Engine using <TextTooltip text="C++"/> or Unity with <TextTooltip text="C#"/> but for learning purposes,
we will be using Java as a spring board to more modern and industry standard languages.

## Aim

The aim is to guide you from a beginner to an intermediate level of proficiency in Java.
For beginners this module is a crucial foundation for your game development endeavors. Along the way, you'll gain a solid
understanding of core programming concepts that will prepare you for more advanced topics in future modules.
...
From there, we'll gradually progress to more advanced topics, such as classes, variables, methods, and object-oriented programming principles.
...
You should have a file named `jdk-22_windows-x64_bin.exe` or similar.

:::note

There are no plans to keep this module up to date with the latest Java version.\
The version I will be using at the
time of writing will be JDK 22.
...
You should have a file named `ideaIC-2023.3.6.exe` or similar due to version changes.
...
You're now ready to dive into the projects section starting with [Hello World!](/docs/java-hello-world)
